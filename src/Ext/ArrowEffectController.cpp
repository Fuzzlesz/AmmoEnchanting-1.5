...
namespace Ext
{
	...
	void ArrowEffectController::AttachArrow(RE::Actor* a_actor, bool a_firstPerson)
	{
		...
		// Static cast fxAttachRoot to RE::NiNode*
		auto fxAttachRootNode = static_cast<RE::NiNode*>(fxAttachRoot);

		RE::TaskQueueInterface::GetSingleton()->QueueNodeAttach(model.get(), fxAttachRootNode);
